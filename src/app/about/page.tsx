  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-2 md:px-4">
      ...
      <div className="text-center mb-14">
        ...
        <h1 className="text-3xl md:text-5xl font-extrabold mb-4 text-[#1A1F1F] dark:text-[#F8FAFC] tracking-tight">About ZenScout AI</h1>
        <p className="text-base md:text-lg text-[#596060] dark:text-[#CBD5E1] max-w-3xl mx-auto leading-relaxed font-light">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-14">
        <div className="bg-[#FAF9F6] dark:bg-[#141B20] p-8 rounded-3xl border border-[#D8E2DA] dark:border-[#232D36] shadow-soft text-center">
          ...
          <h2 className="text-xl font-bold mb-3 text-[#1A1F1F] dark:text-[#F8FAFC]">Our Mission</h2>
          <p className="text-[#596060] dark:text-[#CBD5E1] text-sm leading-relaxed">
        ...
        <div className="bg-[#FAF9F6] dark:bg-[#141B20] p-8 rounded-3xl border border-[#D8E2DA] dark:border-[#232D36] shadow-soft text-center">
          ...
          <h2 className="text-xl font-bold mb-3 text-[#1A1F1F] dark:text-[#F8FAFC]">Zen Ecosystem</h2>
          <p className="text-[#596060] dark:text-[#CBD5E1] text-sm leading-relaxed">
        ...
        <div className="bg-[#FAF9F6] dark:bg-[#141B20] p-8 rounded-3xl border border-[#D8E2DA] dark:border-[#232D36] shadow-soft text-center">
          ...
          <h2 className="text-xl font-bold mb-3 text-[#1A1F1F] dark:text-[#F8FAFC]">Zero-Backend Privacy</h2>
          <p className="text-[#596060] dark:text-[#CBD5E1] text-sm leading-relaxed">
      ...
      <section className="bg-gradient-to-br from-white via-[#F8FAFC] to-teal-50/40 dark:from-[#141B20] dark:via-[#1A2228] dark:to-teal-950/20 rounded-3xl p-6 sm:p-10 md:p-12 mb-14 border border-[#D8E2DA] dark:border-[#232D36] shadow-soft relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-10 relative z-10">
          ...
          <div className="flex flex-col items-center flex-shrink-0">
            <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-3xl overflow-hidden border-2 border-[#476550]/30 dark:border-[#2DD4BF]/40 shadow-xl relative group">
              <img 
                src="/founder.jpg" 
                alt="Jagadeeswara Rao Peddada - Founder & Lead Architect at Aneevarp Solutions"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
              <div className="absolute bottom-2 inset-x-2 bg-[#0B0F12]/80 backdrop-blur-md rounded-xl py-1 text-center text-[10px] font-black text-[#A2BCA8] dark:text-[#2DD4BF] border border-teal-500/30 dark:border-[#2DD4BF]/40">
                VERIFIED FOUNDER
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center gap-2">
              <a
                ...
                className="text-xs font-bold text-[#476550] dark:text-[#2DD4BF] hover:underline inline-flex items-center gap-1 bg-[#E8F0EB] dark:bg-[#2DD4BF]/15 px-3 py-1 rounded-full border border-[#A2BCA8]/40 dark:border-[#2DD4BF]/30 btn-tactile"
              >
                <span>Portfolio</span>
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            <div className="space-y-1">
              <span className="text-xs font-black uppercase tracking-widest text-[#476550] dark:text-[#2DD4BF] block">Leadership & System Architecture</span>
              <h2 className="text-2xl sm:text-3xl font-black text-[#1A1F1F] dark:text-[#F8FAFC]">
                Jagadeeswara Rao Peddada
              </h2>
              <p className="text-sm font-bold text-[#596060] dark:text-[#CBD5E1]">
                Founder & Lead Architect @ <strong>Aneevarp Solutions</strong>
              </p>
            </div>

            <p className="text-sm sm:text-base text-[#596060] dark:text-[#CBD5E1] leading-relaxed font-normal">
              ...
              <div className="grid sm:grid-cols-3 gap-2.5">
                ...
                >
                  <div className="text-left">
                    ...
                    <span className="text-[10px] text-[#7D8787] dark:text-[#94A3B8]">ATS Resume Builder</span>
                  </div>
      ...
      <div className="bg-[#FAF9F6] dark:bg-[#141B20] p-8 md:p-12 rounded-3xl mb-14 border border-[#D8E2DA] dark:border-[#232D36] shadow-soft">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#1A1F1F] dark:text-[#F8FAFC]">About Aneevarp Solutions</h2>
        <p className="text-[#596060] dark:text-[#CBD5E1] leading-relaxed mb-4 text-base">
        ...
        <p className="text-[#596060] dark:text-[#CBD5E1] leading-relaxed mb-6 text-sm">
        ...
        <div className="grid sm:grid-cols-3 gap-4 pt-6 border-t border-[#D8E2DA] dark:border-[#232D36]">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm font-bold text-[#1A1F1F] dark:text-[#F8FAFC]">Hyderabad / Visakhapatnam, India</span>
          </div>
          <div className="flex flex-col gap-1">
            <span className="text-xs text-[#7D8787] dark:text-[#94A3B8]">Statutory Contact Desk</span>
            <a href="mailto:aneevarpsolutions@gmail.com" className="text-sm font-bold text-[#476550] dark:text-[#2DD4BF] hover:underline">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-4 text-[#1A1F1F] dark:text-[#F8FAFC]">Ready to automate your search?</h2>
        <Link 
          href="/dashboard" 
          className="inline-flex items-center gap-2 bg-[#476550] hover:bg-[#3A5342] dark:bg-[#2DD4BF] dark:text-[#061B18] dark:hover:bg-[#5EEAD4] text-white font-semibold px-8 py-3.5 rounded-full transition-all shadow-md active:scale-95 btn-tactile"
        >
