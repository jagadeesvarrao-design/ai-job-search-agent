...
export default function AboutPage() {
  return (
    <div className="max-w-5xl mx-auto py-8 px-2 md:px-4">
      ...
      <section className="bg-gradient-to-br from-white via-[#F8FAFC] to-teal-50/40 dark:from-[#141B20] dark:via-[#1A2228] dark:to-teal-950/20 rounded-3xl p-6 sm:p-10 md:p-12 mb-14 border border-[#E2E8F0] dark:border-[#232D36] shadow-soft relative overflow-hidden">
        {/* Ambient Glow */}
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-10 relative z-10">
          ...
          <div className="flex flex-col items-center flex-shrink-0">
            <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-3xl overflow-hidden border-2 border-[#00685F]/30 dark:border-[#2DD4BF]/40 shadow-xl relative group">
              <img 
                src="/founder.jpg" 
                alt="Jagadeeswara Rao Peddada - Founder & Lead Architect at Aneevarp Solutions"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
              <div className="absolute bottom-2 inset-x-2 bg-slate-900/80 backdrop-blur-md rounded-xl py-1 text-center text-[10px] font-black text-[#2DD4BF] border border-teal-500/30">
                VERIFIED FOUNDER
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center gap-2">
              <a
                ...
                className="text-xs font-bold text-[#00685F] dark:text-[#2DD4BF] hover:underline inline-flex items-center gap-1 bg-teal-50 dark:bg-teal-950/60 px-3 py-1 rounded-full border border-teal-200 dark:border-teal-800"
              >
                <span>Portfolio</span>
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            <div className="space-y-1">
              <span className="text-xs font-black uppercase tracking-widest text-[#00685F] dark:text-[#2DD4BF] block">Leadership & System Architecture</span>
              <h2 className="text-2xl sm:text-3xl font-black text-[#171D1C] dark:text-white">
                Jagadeeswara Rao Peddada
              </h2>
              <p className="text-sm font-bold text-[#545F73] dark:text-slate-300">
                Founder & Lead Architect @ <strong>Aneevarp Solutions</strong>
              </p>
            </div>

            <p className="text-sm sm:text-base text-[#3D4947] dark:text-slate-200 leading-relaxed font-normal">
            ...
            <div className="pt-3 border-t border-slate-200/80 dark:border-slate-800/80">
              ...
              <div className="grid sm:grid-cols-3 gap-2.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-2xl bg-white dark:bg-[#141B20] border border-[#E2E8F0] dark:border-[#232D36] hover:border-[#00685F] dark:hover:border-[#2DD4BF] transition-all flex items-center justify-between group shadow-sm"
                >
                  <div className="text-left">
                    <span className="text-xs font-black text-black dark:text-white block group-hover:text-[#00685F] dark:group-hover:text-[#2DD4BF] transition-colors">ZenResume</span>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400">ATS Resume Builder</span>
                  </div>
                  <ExternalLink className="w-3.5 h-3.5 text-slate-400 group-hover:text-[#00685F] dark:group-hover:text-[#2DD4BF]" />
                </a>

                <div className="p-3 rounded-2xl bg-white dark:bg-[#141B20] border border-teal-300 dark:border-teal-800 shadow-sm text-left">
                  <span className="text-xs font-black text-[#00685F] dark:text-[#2DD4BF] block">ZenScout AI</span>
      ...
      <div className="bg-white dark:bg-[#141B20] p-8 md:p-12 rounded-3xl mb-14 border border-[#E2E8F0] dark:border-[#232D36] shadow-soft">
        ...
        <div className="grid sm:grid-cols-3 gap-4 pt-6 border-t border-[#E2E8F0] dark:border-[#232D36]">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm font-bold text-[#171D1C] dark:text-white">Hyderabad / Visakhapatnam, India</span>
          </div>
          <div className="flex flex-col gap-1">
