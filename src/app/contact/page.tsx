  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-2 md:px-4">
      <div className="text-center mb-10">
        ...
        <p className="text-[#596060] dark:text-slate-400 text-base md:text-lg max-w-2xl mx-auto">
        ...
        <div className="md:col-span-7 bg-[#FAF9F6] dark:bg-[#222828] p-6 md:p-8 rounded-3xl border border-[#D8E2DA] dark:border-[#2D3636] shadow-soft">
          ...
          {status === "success" ? (
            <div className="bg-[#E8F0EB] dark:bg-[#1A1F1F]/30 border border-[#A2BCA8]/40 dark:border-teal-900 rounded-2xl p-6 text-center space-y-3 animate-in fade-in zoom-in-95">
              ...
              <p className="text-[#596060] dark:text-slate-300 text-xs leading-relaxed max-w-md mx-auto">
              ...
              <button 
                ...
                className="mt-2 text-[#476550] dark:text-[#A2BCA8] hover:underline text-xs font-bold"
              >
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              <div>
                <label className="block text-xs font-bold text-[#596060] dark:text-slate-300 uppercase tracking-wider mb-2">Your Name</label>
                <input 
                  type="text" 
                  required
                  value={formData.name}
              ...
              <div>
                <label className="block text-xs font-bold text-[#596060] dark:text-slate-300 uppercase tracking-wider mb-2">Email Address</label>
                <input 
                  type="email" 
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-[#596060] dark:text-slate-300 uppercase tracking-wider mb-2">Inquiry / Grievance Details</label>
                <textarea 
                  required
                  rows={4}
              ...
              <button
                ...
                className="bg-[#476550] hover:bg-[#3A5342] dark:bg-[#6B9077] dark:hover:bg-[#55735E] text-white font-semibold py-3 px-6 rounded-xl transition-all shadow-md active:scale-95 btn-tactile disabled:opacity-50 flex items-center justify-center gap-2 mt-2"
              >
        ...
        <div className="md:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-[#FAF9F6] dark:bg-[#222828] p-6 rounded-3xl border border-[#D8E2DA] dark:border-[#2D3636] shadow-soft flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[#596060] dark:text-slate-400 text-[11px] mb-1.5">For technical queries and product inquiries.</p>
              <a href="mailto:aneevarpsolutions@gmail.com" className="text-[#476550] dark:text-[#A2BCA8] text-xs font-bold hover:underline">
          ...
          <div className="bg-[#FAF9F6] dark:bg-[#222828] p-6 rounded-3xl border border-[#D8E2DA] dark:border-[#2D3636] shadow-soft flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[#596060] dark:text-slate-400 text-[11px]">
          ...
          <div className="bg-[#FAF9F6] dark:bg-[#222828] p-6 rounded-3xl border border-[#D8E2DA] dark:border-[#2D3636] shadow-soft flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[#596060] dark:text-slate-400 text-[11px] mb-1">Operating Organization</p>
