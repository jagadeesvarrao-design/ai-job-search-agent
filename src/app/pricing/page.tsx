    ...
    <div className="max-w-5xl mx-auto py-6 sm:py-10 px-2 sm:px-4 text-center">
      ...
      <div className="my-6 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-teal-950 via-slate-900 to-teal-950 border-2 border-teal-400/60 shadow-2xl text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-left relative overflow-hidden">
        ...
        <button
          ...
          className="w-full md:w-auto bg-gradient-to-r from-[#476550] to-[#A2BCA8] hover:from-[#3A5342] hover:to-[#6B9077] text-slate-950 font-black py-4 px-8 rounded-2xl text-sm shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2 flex-shrink-0 relative z-10 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-left my-6">
        ...
        <div className="p-6 sm:p-8 rounded-3xl border border-[#D8E2DA] dark:border-[#2D3636] bg-[#FAF9F6] dark:bg-[#222828] shadow-soft hover:shadow-soft-hover transition-all flex flex-col justify-between">
          ...
          <button
            ...
            disabled={isUpgrading}
            className="mt-8 w-full bg-slate-100 hover:bg-[#476550] hover:text-white dark:bg-[#1F2525] dark:hover:bg-[#6B9077] dark:hover:text-slate-950 text-[#476550] dark:text-[#A2BCA8] font-black py-3.5 px-4 rounded-xl text-xs transition-all border border-[#476550]/30 active:scale-95 flex items-center justify-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="p-6 sm:p-8 rounded-3xl border border-[#D8E2DA] dark:border-[#2D3636] bg-[#FAF9F6] dark:bg-[#222828] shadow-soft hover:shadow-soft-hover transition-all flex flex-col justify-between">
          ...
          <button
            ...
            disabled={isUpgrading}
            className="mt-8 w-full bg-[#476550] hover:bg-[#3A5342] dark:bg-[#6B9077] dark:hover:bg-[#55735E] text-white font-black py-3.5 px-4 rounded-xl text-xs transition-all shadow-md active:scale-95 btn-tactile flex items-center justify-center gap-1.5 cursor-pointer"
          >
