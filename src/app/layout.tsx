  ...
  return (
    <html lang="en" className={`${inter.variable} ${outfit.variable} h-full antialiased`}>
              ...
              (function() {
                try {
                  ...
                  if (v !== "aneevarp_v4") {
                    ...
                    localStorage.setItem("theme_version", "aneevarp_v4");
      ...
      <body className="min-h-full flex flex-col bg-[#F7F9F6] dark:bg-[#07130E] text-[#1A1F1F] dark:text-[#F8FAFC] font-sans antialiased selection:bg-[#476550] selection:text-white dark:selection:bg-[#2DD4BF] dark:selection:text-[#061B18] transition-colors duration-300 overflow-x-hidden w-full">
        ...
        <a 
          href="#main-content" 
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:bg-[#476550] dark:focus:bg-[#2DD4BF] focus:text-white dark:focus:text-[#061B18] focus:px-4 focus:py-2 focus:rounded-xl focus:font-bold focus:shadow-xl focus:outline-none"
        >
        ...
        <AuthProvider>
          ...
          {/* Main Workspace */}
          <main id="main-content" className="flex-1 w-full max-w-[1280px] mx-auto px-4 md:px-8 py-6 pb-28 md:pb-8">
            {children}
          </main>
        </AuthProvider>
        ...
        <footer className="w-full bg-[#FAF9F6] dark:bg-[#06110D] border-t border-[#D8E2DA] dark:border-[rgba(45,212,191,0.15)] mt-auto transition-colors duration-300">
          <div className="w-full py-8 pb-24 md:pb-8 px-4 md:px-8 max-w-[1280px] mx-auto flex flex-col gap-6">
            
            {/* Top Footer Row */}
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex flex-col md:flex-row items-center gap-3 text-center md:text-left">
                <div className="flex items-center gap-2 font-black text-base text-black dark:text-white">
                  <div className="bg-[#476550] dark:bg-[#2DD4BF] text-white dark:text-[#061B18] p-1.5 rounded-xl shadow-sm">
              ...
              <nav className="flex flex-wrap justify-center items-center gap-5 text-xs font-bold text-[#1A1F1F] dark:text-[#CBD5E1]" aria-label="Footer Navigation">
                ...
                <Link href="/privacy" className="hover:text-[#476550] dark:hover:text-[#2DD4BF] transition-colors">Privacy Policy (DPDP)</Link>
                <Link href="/terms" className="hover:text-[#476550] dark:hover:text-[#2DD4BF] transition-colors">Terms of Service</Link>
              </nav>
            </div>
