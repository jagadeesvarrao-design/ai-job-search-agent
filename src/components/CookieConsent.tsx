...
export default function CookieConsent() {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#222828] p-6 rounded-3xl border-2 border-[#D8E2DA] dark:border-[#2D3636] shadow-2xl transition-colors">
        <div className="flex items-start gap-3.5 mb-3">
          <div className="p-2.5 bg-teal-50 dark:bg-teal-950/50 rounded-2xl text-[#476550] dark:text-[#A2BCA8] flex-shrink-0">
        ...
        <div className="flex items-center gap-3 mt-4 pt-3 border-t border-[#D8E2DA] dark:border-[#2D3636]">
          ...
          <button
            ...
            className="flex-1 bg-[#F8FAFC] hover:bg-slate-200 dark:bg-[#1F2525] dark:hover:bg-[#2D3636] text-black dark:text-[#CBD5E1] border border-[#D8E2DA] dark:border-[#2D3636] text-xs font-bold py-3 px-4 rounded-xl transition-all active:scale-95"
          >
